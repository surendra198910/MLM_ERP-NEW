                    ...
                    <div className="sm:grid sm:grid-cols-2 sm:gap-[25px]">
                      ...
                      <div className="mb-[20px] sm:mb-0">
                        ...
                        <input
                          type="email"
                          className="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                          placeholder="E.g. olivia@trezo@gmail"
                        />
                      </div>
                      ...
                      <div className="mb-[20px] sm:mb-0">
                        ...
                        <select className="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[14px] block w-full outline-0 cursor-pointer transition-all focus:border-primary-500">
                          ...
                          <option>Python Upgrade</option>
                          <option>Project Monitoring</option>
                          <option>Project Alpho</option>
                          <option>Aegis Service</option>
                          <option> Beja Banking Finance</option>
                          <option>Aoriv AI Design</option>
                          <option>Vaxo App Design</option>
                          <option>Product Development</option>
                          <option>Trezo Dashboard</option>
                        </select>
                      </div>
                    </div>
