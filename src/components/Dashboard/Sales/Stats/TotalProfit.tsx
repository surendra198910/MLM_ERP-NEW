    ...
    <>
      <div className="relative rounded-md p-[20px] md:p-[25px] !pb-[65px] mb-[25px] border border-gray-100 dark:border-[#172036]">
        <div className="flex items-center">
          <div className="bg-secondary-100 dark:bg-[#15203c] text-white text-center relative z-[1] ltr:mr-[15px] rtl:ml-[15px] rounded-[5px] text-[25px] w-[55px] h-[55px]">
        ...
        <div className="mt-[25px] md:mt-[45px] flex items-center">
          <span className="font-medium inline-block relative text-xs rounded-full border border-danger-300 text-orange-600 bg-danger-200 dark:bg-[#15203c] dark:border-[#15203c] py-[2px] ltr:pl-[20px] rtl:pr-[20px] ltr:pr-[10px] rtl:pl-[10px]">
