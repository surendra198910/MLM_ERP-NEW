          ...
          <ul className="mb-[20px] md:mb-[25px]">
            <li className="font-medium mb-[15px] md:mb-[19px] last:mb-0">
              <Link
                ...
                className={`relative flex items-center justify-between ltr:pl-[28px] rtl:pr-[28px] transition-all hover:text-primary-500 ${
                  pathname.pathname === "/apps/file-manager/my-drive"
                    ? "text-primary-500 "
                    : ""
                }`}
              >
              ...
              <ul className="ltr:pl-[28px] rtl:pr-[28px] mt-[15px] md:mt-[17px] mb-[17px] md:mb-[21px]">
                <li className="font-normal mb-[12px] md:mb-[14px] last:mb-0">
                  <Link
                    ...
                    className={`nline-block relative transition-all hover:text-primary-500 ltr:pl-[15px] rtl:pr-[15px] ${
                      pathname.pathname === "/apps/file-manager/assets"
                        ? "text-primary-500 "
                        : ""
                    }`}
                  >
                ...
                <li className="font-normal mb-[12px] md:mb-[14px] last:mb-0">
                  <Link
                    ...
                    className={`nline-block relative transition-all hover:text-primary-500 ltr:pl-[15px] rtl:pr-[15px] ${
                      pathname.pathname === "/apps/file-manager/projects"
                        ? "text-primary-500 "
                        : ""
                    }`}
                  >
                ...
                <li className="font-normal mb-[12px] md:mb-[14px] last:mb-0">
                  <Link
                    ...
                    className={`nline-block relative transition-all hover:text-primary-500 ltr:pl-[15px] rtl:pr-[15px] ${
                      pathname.pathname === "/apps/file-manager/personal"
                        ? "text-primary-500 "
                        : ""
                    }`}
                  >
                ...
                <li className="font-normal mb-[12px] md:mb-[14px] last:mb-0">
                  <Link
                    ...
                    className={`nline-block relative transition-all hover:text-primary-500 ltr:pl-[15px] rtl:pr-[15px] ${
                      pathname.pathname === "/apps/file-manager/applications"
                        ? "text-primary-500 "
                        : ""
                    }`}
                  >
            ...
            <li className="font-medium mb-[15px] md:mb-[19px] last:mb-0">
              <Link
                ...
                className={`relative flex items-center justify-between ltr:pl-[28px] rtl:pr-[28px] transition-all text-black dark:text-white hover:text-primary-500 ${
                  pathname.pathname === "/apps/file-manager/documents"
                    ? "text-primary-500 "
                    : ""
                }`}
              >
            ...
            <li className="font-medium mb-[15px] md:mb-[19px] last:mb-0">
              <Link
                ...
                className={`relative flex items-center justify-between ltr:pl-[28px] rtl:pr-[28px] transition-all text-black dark:text-white hover:text-primary-500 ${
                  pathname.pathname === "/apps/file-manager/media"
                    ? "text-primary-500 "
                    : ""
                }`}
              >
            ...
            <li className="font-medium mb-[15px] md:mb-[19px] last:mb-0">
              <Link
                ...
                className={`relative flex items-center justify-between ltr:pl-[28px] rtl:pr-[28px] transition-all text-black dark:text-white hover:text-primary-500 ${
                  pathname.pathname === "/apps/file-manager/recents"
                    ? "text-primary-500 "
                    : ""
                }`}
              >
            ...
            <li className="font-medium mb-[15px] md:mb-[19px] last:mb-0">
              <Link
                ...
                className={`relative flex items-center justify-between ltr:pl-[28px] rtl:pr-[28px] transition-all text-black dark:text-white hover:text-primary-500 ${
                  pathname.pathname === "/apps/file-manager/important"
                    ? "text-primary-500 "
                    : ""
                }`}
              >
            ...
            <li className="font-medium mb-[15px] md:mb-[19px] last:mb-0">
              <Link
                to="#"
                className={`relative flex items-center justify-between ltr:pl-[28px] rtl:pr-[28px] transition-all text-black dark:text-white hover:text-primary-500 ${
                  pathname.pathname === "#" ? "text-primary-500 " : ""
                }`}
              >
