    ...
    <div className={`main-content-wrap transition-all ${active ? "active" : ""}`}>
        ...
        <div className="main-content flex flex-col overflow-hidden min-h-screen transition-all">
          ...
          <Routes>
            ...
            <Route path="/superadmin/forms/form-categories" element={<FormCategory />} />
            <Route path="/superadmin/forms/forms" element={<Forms />} />
            <Route path="/superadmin/employee/add-employee" element={<AddEditEmployee />} />
            <Route path="superadmin/employee/edit/:id?" element={<AddEditEmployee key={location.pathname}  />} />
            <Route path="/superadmin/employee/manage-employee" element={<ManageEmployee />} />
            ...
            <Route path="/superadmin/kyc-documents-master/client-documents" element={<CustomerDocument />} />
            <Route path="/superadmin/human-resource/designation" element={<Designation />} />
            <Route path="/superadmin/human-resource/department" element={<Department />} />
            <Route path="/superadmin/bills/payments/payment-mode" element={<PaymentMode />} />
            <Route path="/superadmin/company/add-company" element={<AddCompany />} />
            <Route path="/superadmin/company/manage-company/branch" element={<ManageCompany />} />
            <Route path="/superadmin/project-setting/task-type" element={<TaskType />} />
            <Route path="/superadmin/employee-setting/employee-type" element={<EmployeeType />} />
            <Route path="/superadmin/employee-setting/login-type" element={<LoginType />} />
            <Route path="/superadmin/enquiry-setting/enquiry-for" element={<EnquiryFor />} />
            <Route path="/superadmin/enquiry-setting/enquiry-type" element={<EnquiryType />} />
            <Route path="/superadmin/enquiry-setting/how-did-you-find-us-type" element={<FindUsType />} />
            <Route path="/superadmin/expenses/expense-item" element={<ExpenseItem />} />
            <Route path="/superadmin/expenses/expense-head" element={<ExpenseHead />} />
            <Route path="/superadmin/expenses/expenditure-group" element={<ExpenditureGroup />} />
            <Route path="/superadmin/company/add-company" element={<AddCompany />} />
            <Route path="/superadmin/company/add-company/edit/:id" element={<AddCompany />} />
            <Route path="/superadmin/company/manage-company/branch" element={<ManageCompany />} />
            <Route path="/superadmin/company/manage-company/branch/edit/:id" element={<ManageCompany />} />
            <Route path="/superadmin/company-setting/currency-master" element={<CurrencyMaster />} />
