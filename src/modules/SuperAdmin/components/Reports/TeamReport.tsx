...
const Template: React.FC = () => {
    ...
    const statsConfig = [
        { key: "TotalTeamBusiness", title: "Team Business", icon: "groups", variant: "income" },
        { key: "TotalWithdraw", title: "Withdraw", icon: "payments", variant: "expense" },
        { key: "TotalPayout", title: "Payout", icon: "account_balance_wallet", variant: "income" },
        { key: "TotalBots", title: "Bots Activated", icon: "smart_toy", variant: "highlight" },
    ];
    ...
    const fetchGridColumns = async () => {
        ...
        try {
            const payload = {
                ...
                Para: JSON.stringify({
                    UserId: employeeId,
                    GridName: "USP_TeamBusinessReport",
                }),
            };
    ...
    const fetchVisibleColumns = async () => {
        ...
        const payload = {
            ...
            Para: JSON.stringify({
                EmployeeId: employeeId,
                USPName: "USP_TeamBusinessReport",
                ActionMode: "List",
                Mode: "Get",
            }),
        };
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3 flex-wrap justify-end">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                >
                                    <ColumnSelector
                                        procName="USP_TeamBusinessReport"
        ...
        ${SmartActions.canSearch(formName)
            ...
            {!showTable && (
                <LandingIllustration
                    ...
                    description={
                        <>
                            Search Team Report using filters above.<br />
