...
const Template: React.FC = () => {
    ...
    const statsConfig = [
        { key: "TotalInvestment", title: "Total Investment", icon: "payments", variant: "income" },
        { key: "ThisMonthInvestment", title: "This Month Investment", icon: "calendar_month", variant: "income" },
        { key: "LastMonthInvestment", title: "Last Month Investment", icon: "history", variant: "income" },
        { key: "TodayInvestment", title: "Today Investment", icon: "today", variant: "highlight" },
    ];
    ...
    const fetchGridColumns = async () => {
        ...
        try {
            const payload = {
                ...
                Para: JSON.stringify({
                    UserId: employeeId,
                    GridName: "USP_InvestmentReportAdmin",
                }),
            };
        ...
        ${SmartActions.canSearch(formName)
            ...
            {!showTable && (
                <LandingIllustration
                    ...
                    description={
                        <>
                            Search Investment Report using filters above.<br />
