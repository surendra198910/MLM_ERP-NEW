...
const Template: React.FC = () => {
   ...
   const statsConfig = [
  { key: "TotalWithdraw", title: "Total Withdraw", icon: "payments", variant: "income" },
  { key: "TodayWithdraw", title: "Today Withdraw", icon: "today", variant: "highlight" },
  { key: "PendingWithdraw", title: "Pending Withdraw", icon: "schedule", variant: "warning" },
  { key: "ApprovedWithdraw", title: "Approved Withdraw", icon: "check_circle", variant: "success" },
];
    ...
    const fetchVisibleColumns = async () => {
        ...
        const payload = {
            ...
            Para: JSON.stringify({
                EmployeeId: employeeId,
                USPName: "USP_EmployeeAdminReports",
                ActionMode: "List",
                Mode: "Get",
            }),
        };
        ...
        ${SmartActions.canSearch(formName)
            ...
            {!showTable && (
                <LandingIllustration
                    ...
                    description={
                        <>
                            Search Withdraw Report using filters above.<br />
