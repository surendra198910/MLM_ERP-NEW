                ...
                <div className="overflow-hidden border rounded-md border-gray-100 dark:border-gray-800  bg-white dark:bg-gray-900/50">
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-primary-table-bg dark:bg-gray-800/80 border-b border-gray-200 dark:border-gray-700">
                            <tr>
                                <th className="p-4 text-[13px]  text-primary-table-text">Theme Name</th>
                                ...
                                <th className="p-4 text-[13px]  text-primary-table-text text-center w-28">Status</th>
                                <th className="p-4 text-[13px] text-primary-table-text text-center w-20">Edit</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                            {themes.map((t) => (
                                <tr key={t.ThemeId} className="hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-colors group">
                                    <td className="p-4">
                                        <div className="text-gray-800 dark:text-gray-100 text-sm">{t.ThemeName}</div>
...
p-[20px] md:p-[25px] rounded-t-md">
                                        <div className="trezo-card-title">
                                            <h5 className="!mb-0">
                                                {isEdit ? "Update Theme Designer" : "Create New Theme Architecture"}
                                            </h5>
                                        </div>
                                        <button
                                            type="button"
                                        ...
                                        {({ values, handleChange }) => (
                                            <Form className="flex flex-col overflow-hidden">
                                                <div className="space-y-6 overflow-y-auto bg-gray-50/30 dark:bg-transparent">
                                                    ...
                                                    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border-1 border-gray-200 dark:border-gray-700 flex items-center gap-6">
                                                        <label className="text-xs  text-gray-500 dark:text-blue-400 whitespace-nowrap">Unique Theme Name</label>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                                        <CompactSection title="1. Panel Gradient">
                                                            <ColorInput label="Start" name="primaryStart" value={values.primaryStart} onChange={handleChange} />
                                                            <ColorInput label="End" name="primaryEnd" value={values.primaryEnd} onChange={handleChange} />
                                                            <div className="h-8 w-full mt-3 rounded-lg border-1 border-gray-200 dark:border-gray-600 shadow-inner" style={{ background: `linear-gradient(90deg, ${values.primaryStart}, ${values.primaryEnd})` }} />
                                                        </CompactSection>
                                                        ...
                                                        <CompactSection title="2. Sidebar Color">
                                                            ...
                                                            <ColorInput label="Sidebar Active Text" name="sidebarText" value={values.sidebarText} onChange={handleChange} />
                                                        ...
                                                        <CompactSection title="4. Button Style">
                                                            ...
                                                            <div className="mt-3 text-[10px] text-center p-2 rounded-lg border-1 border-gray-200 dark:border-gray-700 shadow-md" style={{ background: `linear-gradient(to right, ${values.btnStart}, ${values.btnEnd})`, color: values.btnText }}>PREVIEW</div>
                                                        </CompactSection>
                                                        ...
                                                        <CompactSection title="5. Button Hover">
                                                            ...
                                                            <div className="mt-3 text-[10px] text-center p-2 rounded-lg border-1 border-gray-200 dark:border-gray-700 shadow-lg" style={{ backgroundColor: values.btnHoverBg, color: values.btnHoverText }}>HOVER STATE</div>
                                                        </CompactSection>
                                                        ...
                                                        <CompactSection title="7. Typography">
                                                            <div className="space-y-4">
                                                                ...
                                                                <div className="flex flex-col gap-1">
                                                                    <label className="text-[9px] text-gray-400  tracking-tighter">Font Family</label>
                                                            ...
                                                            <div className="space-y-3">
                                                                ...
                                                                <div className="flex items-center justify-between border-1 border-gray-200 p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl border dark:border-gray-700 mt-2">
                                                                    <div className="flex flex-col">
                                                                        <span className="text-[10px] text-gray-600 dark:text-gray-300  tracking-tighter">Interface Style</span>
                                                                        <span className="text-[8px] text-gray-400 ">Dark Mode Default</span>
                                                                    </div>
                                                                    <Switch
                                                ...
                                                <div className="text-right mt-[20px]">
                                                    <button type="button" onClick={() => setOpenModal(false)} className="mr-[15px] px-[26.5px] py-[12px] rounded-md bg-danger-500 text-white hover:bg-danger-400">Cancel Changes</button>
                                                    <button type="submit" className="px-[26.5px] py-[12px] rounded-md bg-primary-button-bg text-white hover:bg-primary-button-bg-hover">
                                                        Save Theme Settings
                                                    </button>
                                                </div>
                                            </Form>
...
const CompactSection = ({ title, children }: any) => (
    <div className="p-4 border-b border-gray-400 dark:border-gray-700 rounded-2xl bg-white dark:bg-gray-800/20 shadow-sm hover:shadow-md transition-shadow">
        <h6 className="text-[10px] text-blue-500  tracking-[0.15em] mb-3 border-b border-gray-200 dark:border-gray-700 pb-2 ">{title}</h6>
