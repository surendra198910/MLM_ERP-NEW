...
const Template: React.FC = () => {
  ...
  const handleEdit = (row) => {
    ...
    navigate(`/superadmin/client/add-client/${row.ClientId}`);
  ...
  useEffect(() => {
    ...
    fetchGridData();
  }, [page, perPage, sortColumnKey, sortDirection, searchTrigger]);
  const applySearch = () => {
    ...
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
      ...
      {!showTable && (
        <LandingIllustration
          ...
          description={
            <>
              Search Client using filters above.
              <br />
