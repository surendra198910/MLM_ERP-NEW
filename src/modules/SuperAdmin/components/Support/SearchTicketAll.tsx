...
import ActionCell from "../../../../components/CommonFormElements/DataTableComponents/ActionCellForSupport";
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          Status: "", // optional (you can add dropdown later)
          EmployeeId: 0,
        }),
      };
    ...
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <button
                  ...
                  disabled={!SmartActions.canAdd(formName)}
                  onClick={() =>
                    navigate("/superadmin/support-center/createticket")
                  }
      ...
      {!showTable && (
        <LandingIllustration
          ...
          description={
            <>
              Search Support Tickets using filters above.
              <br />
