...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Enquiry For");
    XLSX.writeFile(workbook, "enquiry_for.xlsx");
  };
  ...
  const [sortColumn, setSortColumn] = useState("EQID");
  ...
  const fetchVisibleColumns = async () => {
    try {
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) => c.IsVisible == 1 && c.ColumnName !== "EQID", // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder),
      );
    } catch (err) {
  ...
  const formSchema = Yup.object().shape({
    EnquiryFor: Yup.string().required("Document name is required"),
  });
...
const fetchDocumentPermissions = async () => {
  ...
  //     console.log("🧠 Enquiry For Actions:", actions);
  //   }, 300);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Enquiry For</h5>
          </div>
              ...
              SmartActions.canAdvancedSearch(CURRENT_FORM_ID)
                ...
                : "bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed"
                    ...
                    >
                      ...
                      <option value="EnquiryFor">Enquiry For Name</option>
                    </select>
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                Search Enquiry For data by <br />
                using above filters to edit, delete etc.
                <br />
                OR <br />
                Click Below to add New Enquiry For
              </p>
...
p-[20px] md:p-[25px] rounded-t-md"
                  >
                    <div className="trezo-card-title">
                      <h5 className="!mb-0">
                        {isEdit ? "Edit Enquiry For" : "Add New Enquiry For"}
                      </h5>
                    </div>
                    <button
                      type="button"
                      ...
                      onSubmit={async (values, { resetForm }) => {
                        try {
                          ...
                          if (res?.StatusCode === "1") {
                            ShowSuccessAlert(
                              isEdit
                                ? "Enquiry For Updated Successfully"
                                : "Enquiry For Added Successfully",
                            );
                          ...
                          <Form className="space-y-5">
                            ...
                            <div>
                              ...
                              <Field
                                type="text"
                                name="EnquiryFor"
                                placeholder="Enter Enquiry For Name"
