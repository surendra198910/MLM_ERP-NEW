...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Enquiry Type");
    XLSX.writeFile(workbook, "enquiry_type.xlsx");
  };
  ...
  const [sortColumn, setSortColumn] = useState("ETID");
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_EnquiryTypeMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) => c.IsVisible == 1 && c.ColumnName !== "ETID", // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder),
      );
    } catch (err) {
  ...
  const fetchTableData = async () => {
    try {
      ...
      const payload = {
        procName: "EnquiryTypeMaster", // ✅ FIX
        Para: JSON.stringify({
          ActionMode: "List",
          CompanyId: 1,
          EntryBy: 1,
  ...
  const formSchema = Yup.object().shape({
    EnquiryType: Yup.string().required("Document name is required"),
  });
 ...
 const fetchDocumentPermissions = async () => {
  ...
  //     console.log("🧠 Enquiry Type Actions:", actions);
  //   }, 300);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Enquiry Type</h5>
          </div>
              ...
              SmartActions.canAdvancedSearch(CURRENT_FORM_ID)
                ...
                : "bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed"
                    ...
                    >
                      ...
                      <option value="EnquiryType">Enquiry Type Name</option>
                    </select>
        ...
        ${SmartActions.canSearch(CURRENT_FORM_ID)
                ...
                <div className="relative group">
                  ...
                  >
                    ...
                    >
                      <ColumnSelector
                        procName="USP_EnquiryTypeMaster"
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                Search Enquiry Type data by <br />
                using above filters to edit, delete etc.
                <br />
                OR <br />
                Click Below to add New Enquiry Type
              </p>
...
p-[20px] md:p-[25px] rounded-t-md"
                  >
                    <div className="trezo-card-title">
                      <h5 className="!mb-0">
                        {isEdit ? "Edit Enquiry Type" : "Add New Enquiry Type"}
                      </h5>
                    </div>
                    <button
                      type="button"
                      ...
                      onSubmit={async (values, { resetForm }) => {
                        try {
                          ...
                          if (res?.StatusCode === "1") {
                            ShowSuccessAlert(
                              isEdit
                                ? "Enquiry Type Updated Successfully"
                                : "Enquiry Type Added Successfully",
                            );
