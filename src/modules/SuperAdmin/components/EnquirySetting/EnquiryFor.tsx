...
const Template: React.FC = () => {
  ...
  return (
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
      ...
      {!showTable && (
        <LandingIllustration
          title="Enquiry For Master"
          addLabel="Add Enquiry For"
          formName={formName}
          description={
            <>
              Search Enquiry For using filters above.<br />
              Manage records, export reports and analyse performance.<br />
              <span className="font-medium">OR</span><br />
              Click on Add button to create a new Enquiry For entry.
            </>
          }
        />
      )}
                  ...
                  <Formik
                    ...
                    onSubmit={async (values, { resetForm }) => {
                      ...
                      const confirm = await Swal.fire({
                        ...
                        text: `Do you want to ${actionText} "${values.EnquiryFor}" ?`,
                        icon: "question",
                        showCancelButton: true,
                      ...
                      try {
                        ...
                        const payload = {
                          procName: "EnquiryFor",   // ✅ correct proc
                          Para: JSON.stringify({
                            ActionMode: isEdit ? "Update" : "Insert",  // ✅ correct case
                            EnquiryFor: values.EnquiryFor,

                            // ✅ correct id mapping
                            EditId: isEdit ? editData?.EQID : 0,
