...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const fetchExportData = async () => {
    ...
    const payload = {
      procName: "HowdidyouFindUsMaster",
      Para: JSON.stringify({
        ActionMode: "Export",
        CompanyId: 1,
        EntryBy: 1,
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "How did you Find Us");
    XLSX.writeFile(workbook, "find_us_type.xlsx");
  };
  ...
  const [sortColumn, setSortColumn] = useState("FindId");
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_HowdidyouFindUsMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) => c.IsVisible == 1 && c.ColumnName !== "FindId", // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder),
      );
    } catch (err) {
  ...
  const fetchTableData = async () => {
    try {
      ...
      const payload = {
        procName: "HowdidyouFindUsMaster", // ✅ FIX
        Para: JSON.stringify({
          ActionMode: "List",
          CompanyId: 1,
          EntryBy: 1,
      ...
      setTasks(
        apiRes.map((row) => ({
          FindId: row.FindId,
          HowdidyouFindUs: row.HowdidyouFindUs,
          Status: row.Status,
  ...
  const formSchema = Yup.object().shape({
    HowdidyouFindUs: Yup.string().required("Document name is required"),
  });
  ...
  try {
    ...
    const payload = {
      ...
      Para: JSON.stringify({
        ActionMode: "Forms",
        FormCategoryId: 30, // 👈 category for this page
        EmployeeId: employeeId,
      }),
    };
  ...
  const handlePrint = async () => {
    ...
    <html>
      <head>
        <title>How did you Find Us</title>
        <style>
          body {
  ...
  //     console.log("🧠 How did you Find Us Actions:", actions);
  //   }, 300);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage How did you Find Us</h5>
          </div>
        ...
        ${SmartActions.canSearch(CURRENT_FORM_ID)
                ...
                <div className="relative group">
                  ...
                  >
                    ...
                    >
                      <ColumnSelector
                        procName="USP_HowdidyouFindUsMaster"
...
p-[20px] md:p-[25px] rounded-t-md"
                  ...
                  {editLoading ? (
                    ...
                    <Formik
                      initialValues={{
                        HowdidyouFindUs: editData?.HowdidyouFindUs || "",
                      ...
                      onSubmit={async (values, { resetForm }) => {
                        try {
                          ...
                          if (res?.StatusCode === "1") {
                            ShowSuccessAlert(
                              isEdit
                                ? "How did you Find Us Updated Successfully"
                                : "How did you Find Us Added Successfully",
                            );
                          ...
                          <Form className="space-y-5">
                            ...
                            <div>
                              ...
                              <Field
                                ...
                                placeholder="Enter How did you Find Us Name"
