  ...
  const fetchGridColumns = async () => {
    ...
    try {
      const payload = {
        ...
        Para: JSON.stringify({
          UserId: employeeId,
          GridName: "USP_HowdidyouFindUsMaster",
        }),
      };
...
const handleDelete = async (row: any) => {
  const result = await Swal.fire({
    title: "Are you sure?",
    text: `Delete "${row.HowdidyouFindUs}" ?`, // ✅ correct field
    icon: "warning",
  ...
  try {
    const payload = {
      procName: "HowdidyouFindUsMaster", // ✅ correct proc
      Para: JSON.stringify({
        ActionMode: "Delete",
        EditId: row.FindId, // ✅ correct ID
        CompanyId: 1,
        ModifiedBy: 1,
      }),
    };
    ...
    if (res?.Status == 1 || res?.Status === "1") {
      await Swal.fire({
        icon: "success",
        title: "Deleted!",
        text: res?.Msg || "Deleted successfully", // ✅ Msg (not msg)
        timer: 1500,
  ...
  const fetchVisibleColumns = async () => {
    ...
    const payload = {
      ...
      Para: JSON.stringify({
        EmployeeId: employeeId,
        USPName: "USP_HowdidyouFindUsMaster",
        ActionMode: "List",
        Mode: "Get",
      }),
    };
  ...
  return (
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
            ...
            <div className="relative w-full sm:w-[180px]">
              ...
              >
                ...
                >
                  ...
                  <option value="HowdidyouFindUs">How Did You Find Us</option>
                </select>
      ...
      {!showTable && (
        <LandingIllustration
          title="How Did You Find Us Master"
          addLabel="Add Enquiry Type"
          formName={formName}
          description={
            <>
              Search How Did You Find Ususing filters above.<br />
              Manage records, export reports and analyse performance.<br />
              <span className="font-medium">OR</span><br />
              Click on Add button to create a new How Did You Find Us entry.
            </>
          }
        />
      )}
        ...
        transition-all appearance-none"
              ...
              <PermissionAwareTooltip allowed={canExport}>
                <div className={!canExport ? "pointer-events-none opacity-50" : ""}>
                  <ExportButtons
                    title="How Did You Find UsReport"
                  ...
                  <Formik
                    ...
                    onSubmit={async (values, { resetForm }) => {
                      ...
                      const confirm = await Swal.fire({
                        ...
                        text: `Do you want to ${actionText} "${values.HowdidyouFindUs}" ?`,
                        icon: "question",
                        showCancelButton: true,
                      ...
                      try {
                        ...
                        const payload = {
                          ...
                          Para: JSON.stringify({
                            ...
                            EditId: isEdit ? editData?.FindId : 0,
                            CompanyId: 1,
                            EntryBy: 1,
                            ModifiedBy: 1,
                          }),
