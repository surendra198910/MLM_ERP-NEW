...
const Template: React.FC = () => {
  ...
  const fetchGridColumns = async () => {
    ...
    try {
      const payload = {
        ...
        Para: JSON.stringify({
          UserId: employeeId,
          GridName: "USP_PaymentModeMaster",
        }),
      };
  ...
  const handleDelete = async (row: any) => {
    const result = await Swal.fire({
      title: "Are you sure?",
      text: `Delete "${row.PaymentModeName}" ?`,
      icon: "warning",
    ...
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
            ...
            <div className="relative w-full sm:w-[180px]">
              ...
              >
                ...
                >
                  ...
                  <option value="PaymentModeName">Payment Mode Name</option>
      ...
      {!showTable && (
        <LandingIllustration
          ...
          description={
            <>
              Search Payment Mode  using filters above.<br />
              Manage records, export reports and analyse performance.<br />
              <span className="font-medium">OR</span><br />
              Click on Add button to create a new Payment Mode entry.
            </>
          }
        />
      )}
                ...
                <Formik
                  ...
                  onSubmit={async (values, { resetForm }) => {
                    const confirm = await Swal.fire({
                      title: isEdit ? "Update Payment Mode?" : "Add Payment Mode?",
                    ...
                    try {
                      ...
                      const payload = {
                        ...
                        Para: JSON.stringify({
                          ...
                          EditId: isEdit ? Number(editData?.PaymentModeId) : 0, // ✅ FIXED
                          CompanyId: 1,
                          EntryBy: 1,
                        }),
                      };
