...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const exportCSV = async () => {
    ...
    a.href = url;
    a.download = "client_paymentmode.csv";
    a.click();
  };
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Client paymentmode");
    XLSX.writeFile(workbook, "client_paymentmode.xlsx");
  };
  ...
  const exportPDF = async () => {
    ...
    doc.save("client_paymentmode.pdf");
  };
  ...
  const [sortColumn, setSortColumn] = useState("PaymentModeId");
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_PaymentModeMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) => c.IsVisible == 1 && c.ColumnName !== "PaymentModeId", // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder),
      );
    } catch (err) {
  ...
  const fetchTableData = async () => {
    try {
      ...
      const payload = {
        procName: "PaymentModeMaster", // ✅ FIX
        Para: JSON.stringify({
          ActionMode: "List",
          CompanyId: 1,
          EntryBy: 1,
 ...
 const fetchDocumentPermissions = async () => {
  try {
    ...
    const payload = {
      ...
      Para: JSON.stringify({
        ActionMode: "Forms",
        FormCategoryId: 15, // 👈 category for this page
        EmployeeId: employeeId,
      }),
    };
  ...
  //     SmartyActionStoreInstance.set("Clientpaymentmode", actions);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Payment Mode</h5>
          </div>
            ...
            : "border-gray-300 text-gray-300 cursor-not-allowed"
                ...
                <div className="relative group">
                  ...
                  >
                    ...
                    >
                      <ColumnSelector
                        procName="USP_PaymentModeMaster"
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                Search payment mode data by <br />
                using above filters to edit, delete etc.
                <br />
                OR <br />
                Click Below to add payment mode
              </p>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (!SmartActions.canEdit(CURRENT_FORM_ID))
                                      return;
                                    fetchEditData(task.PaymentModeId);
                                  }}
                                  className={
                                    SmartActions.canEdit(CURRENT_FORM_ID)
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (
                                      ...
                                      return;
                                    handleDelete(task.PaymentModeId);
                                  }}
                                  className={
                                    SmartActions.canDelete(CURRENT_FORM_ID)
                          ...
                          <div className="text-right mt-[20px]">
                            <button
                              ...
                              onClick={() => {
                                ...
                                // setIsEdit(false); // ✅ switches to add mode
