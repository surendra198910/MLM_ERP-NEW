...
const Template: React.FC = () => {
    ...
    return (
                        ...
                        <div className="relative w-full sm:w-[180px]">
                           ...
                           ${SmartActions.canAdvancedSearch(formName)
                                ...
                                >
                                    ...
                                    <option value="TaxName">Tax Name</option>
        ...
        ${SmartActions.canSearch(formName)
            ...
            {!showTable && (
                <LandingIllustration
                    title="Manage Tax Setting"
                    addLabel="Add Tax Setting"
                    formName={formName}
                    description={
                        <>
                            Search tax setting using filters above.<br />
                            Manage records, export reports and analyse performance.<br />
                            <span className="font-medium">OR</span><br />
                            Click on Add button to create a new tax setting entry.
                        </>
                    }
                />
            )}
                                            ...
                                            try {
                                                ...
                                                const payload = {
                                                    ...
                                                    Para: JSON.stringify({
                                                        ...
                                                        EntryBy: 1,
                                                        EditId: isEdit ? Number(editData?.TaxId) : 0, // ✅ FIXED
                                                    }),
                                                };
