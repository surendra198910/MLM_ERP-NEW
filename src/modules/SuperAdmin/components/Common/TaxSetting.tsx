...
const ToDoList: React.FC = () => {
    ...
    const fetchCountries = async () => {
        try {
            ...
            console.log("Calling Country DDL API"); // ✅ debug

            const response = await universalService(payload);
            const res = response?.data || response;

            if (!Array.isArray(res)) {
                console.error("Invalid country response:", res);
                return;
            }
    ...
    const exportCSV = async () => {
        ...
        a.href = url;
        a.download = "Company_documents.csv";
        a.click();
    };
    ...
    const exportExcel = async () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Tax Settings");
        XLSX.writeFile(workbook, "Company_documents.xlsx");
    };
            ...
            setVisibleColumns(
                cols
                    .filter(
                        (c) =>
                            c.IsVisible == 1 &&
                            c.ColumnName !== "TaxId" // 🚫 HIDE DOCUMENT ID
                    )
                    .sort((a, b) => a.DisplayOrder - b.DisplayOrder)
            );
        ...
        try {
            ...
            setTasks(
                apiRes.map((row) => ({
                    ...
                    CountryName: row.CountryName, // ✅ correct
    ...
    const fetchEditData = async (id: number) => {
        ...
        try {
            ...
            setEditData({
                ...
                CountryId: data.CountryId || "", // ✅ correct
            });
    ...
    const fetchDocumentPermissions = async () => {
        try {
            ...
            const payload = {
                ...
                Para: JSON.stringify({
                    ActionMode: "Forms",
                    FormCategoryId: 2, // category for this page
                    EmployeeId: employeeId,
                }),
            };
            ...
            const pagePermission = data.find(
                (p) =>
                    ...
                    Number(p.FormCategoryId) === 2
            );

            // ❌ No access if Action is empty / null
            if (
                !pagePermission ||
            ...
            // ✅ Page access granted → enable SmartActions
  ...
  `);
    ...
    //     SmartyActionStoreInstance.set("CompanyDocuments", actions);
    //     console.log("🧠 Tax Setting Actions:", actions);
    //   }, 300);
    ...
    useEffect(() => {
        ...
        fetchTableData();
    }, [currentPage, itemsPerPage, searchQuery, sortColumn, sortDirection, searchTrigger]);
        ...
        <>
            <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
                    <div className="trezo-card-title">
                        <h5 className="!mb-0">Manage Tax Settings</h5>
                    </div>
            ...
            ${SmartActions.canAdvancedSearch(CURRENT_FORM_ID)
                                        ...
                                        >
                                            ...
                                            <option value="TaxName">Tax Setting Name</option>
                                ...
                                <div className="relative group">
                                    ...
                                    >
                                        <button
                                            ...
                                            className="w-[34px] h-[34px] flex items-center justify-center rounded-md border border-white text-white bg-primary-button-bg hover:border-primary-button-bg hover:bg-white hover:text-primary-button-bg transition-all disabled:opacity-50"
                                        >
                    ...
                    >
                        ...
                        <div className="md:max-w-md md:px-3 px-0 py-14">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                                ...
                                <br />
                                OR <br />
                                Click Below to add New Tax Setting
                            </p>
                ...
                {showTable && (
                    <div className="trezo-card-content -mx-[20px] md:-mx-[25px]">
                        {tableLoading || !columnsReady ? (
                            <div className="px-[20px] md:px-[25px] py-10">
                                <TableSkeleton
                                                        ...
                                                        <div className="flex items-center gap-[9px]">
                                                            ...
                                                            >
                                                                <button
                                                                    ...
                                                                    onClick={() => {
                                                                        if (!SmartActions.canEdit(CURRENT_FORM_ID)) return;
                                                                        fetchEditData(task.TaxId);
                                                                    }}
                                                                    className={
                                                            ...
                                                            {/* Delete */}
                                                            <PermissionAwareTooltip
                                                                allowed={SmartActions.canDelete(CURRENT_FORM_ID)}
                                                                allowedText="Delete"
                                                                deniedText="No delete permission"
                                                            >
                                                                <button
                                                                    type="button"
                                                                    disabled={!SmartActions.canDelete(CURRENT_FORM_ID)}
                                                                    onClick={() => {
                                                                        if (!SmartActions.canDelete(CURRENT_FORM_ID)) return;
                                                                        handleDelete(task.TaxId);
                                                                    }}
                                                                    className={
...
p-[20px] md:p-[25px] rounded-t-md"
                                    >
                                        <div className="trezo-card-title">
                                            <h5 className="!mb-0">
                                                {isEdit ? "Edit Tax Setting" : "Add New Tax Setting"}
                                            </h5>
                                        </div>
                                        <button
                                            type="button"
                                            ...
                                            onSubmit={async (values, { resetForm }) => {
                                                try {
                                                    ...
                                                    if (res?.StatusCode === "1") {
                                                        ...
                                                        await fetchTableData(); // ✅ FORCE REFRESH
                                                    }
                                                    else {
                                                        toast.error(res?.msg || "Server Error", {
                                                            position: "top-right",
                                                            autoClose: 4000,
                                                ...
                                                return (
                                                    <Form className="space-y-5">
                                                        ...
                                                        <div>
                                                            ...
                                                            <Field
                                                                as="select"
                                                                name="CountryId"   // ✅ MUST be CountryId
      ...
      outline-0 cursor-pointer transition-all focus:border-primary-button-bg"
                                                        ...
                                                        <div>
                                                            ...
                                                            <Field
                                                                type="text"
                                                                name="TaxName"
                                                                placeholder="Enter Tax Setting Name"
                                                                className="h-[55px] rounded-md text-black dark:text-white border border-gray-200
...
focus:border-primary-button-bg"
                                                        ...
                                                        {/* <div className="grid grid-cols-2 gap-[25px] mb-6">
                                                            ...
                                                            <div className="flex items-center justify-between pr-4">
                                                                <label className="font-medium">Is Attachment:</label>
