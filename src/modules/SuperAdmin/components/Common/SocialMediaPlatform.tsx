...
const Template: React.FC = () => {
    ...
    const fetchGridColumns = async () => {
        ...
        try {
            const payload = {
                ...
                Para: JSON.stringify({
                    UserId: employeeId,
                    GridName: "USP_SocialMediaPlatfromMaster",
                }),
            };
    ...
    const fetchExportData = async () => {
        const payload = {
            procName: "SocialMediaPlatfromMaster",
            Para: JSON.stringify({
    ...
    const fetchVisibleColumns = async () => {
        ...
        const payload = {
            ...
            Para: JSON.stringify({
                EmployeeId: employeeId,
                USPName: "USP_SocialMediaPlatfromMaster",
                ActionMode: "List",
                Mode: "Get",
            }),
        };
    ...
    return (
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3 flex-wrap justify-end">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                >
                                    <ColumnSelector
                                        procName="USP_SocialMediaPlatfromMaster"
        ...
        ${SmartActions.canSearch(formName)
            ...
            {!showTable && (
                <LandingIllustration
                    title="Social Media Platfrom Master"
                    addLabel="Add Social Media Platfrom"
                    formName={formName}
                    description={
                        <>
                            Search Social Media Platfrom using filters above.<br />
                            Manage records, export reports and analyse performance.<br />
                            <span className="font-medium">OR</span><br />
                            Click on Add button to create a new Social Media Platfrom entry.
                        </>
                    }
                />
            )}
        ...
        transition-all appearance-none"
                            ...
                            <PermissionAwareTooltip allowed={canExport}>
                                <div className={!canExport ? "pointer-events-none opacity-50" : ""}>
                                    <ExportButtons
                                        title="Social Media Platfrom Report"
...
p-[20px] md:p-[25px] rounded-t-md"
                                >
                                    <div className="trezo-card-title">
                                        <h5 className="!mb-0">
                                            {isEdit ? "Edit Social Media Platfrom" : "Add New Social Media Platfrom"}
                                        </h5>
                                    </div>
                                    <button
                                        type="button"
                                    ...
                                    <Formik
                                        ...
                                        onSubmit={async (values, { resetForm }) => {
                                            ...
                                            const confirm = await Swal.fire({
                                                ...
                                                text: `Do you want to ${actionText} "${values.EnquiryType}" ?`,
                                                icon: "question",
                                                showCancelButton: true,
                                            ...
                                            try {
                                                ...
                                                const payload = {
                                                    ...
                                                    Para: JSON.stringify({
                                                        ...
                                                        EditId: isEdit ? editData?.PlatformId : 0,
                                                        EntryBy: 1,
                                                        ModifiedBy: 1,
                                                    }),
                                                };
                                                    ...
                                                    <div className="text-right mt-[20px]">
                                                        ...
                                                        >
                                                            {saving ? (
                                                                ...
                                                                "Update Social Media Platfrom"
                                                            ) : (
                                                                "Add Social Media Platfrom"
                                                            )}
                                                        </button>
                                                    </div>
                                                </Form>
