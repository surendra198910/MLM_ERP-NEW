...
const Template: React.FC = () => {
  ...
  const fetchGridColumns = async () => {
    ...
    try {
      const payload = {
        ...
        Para: JSON.stringify({
          UserId: employeeId,
          GridName: "USP_EmployeeDocumentsMaster",
        }),
      };
  ...
  const handleEdit = async (row) => {
    ...
    try {
      ...
      const payload = {
        procName: "EmployeeDocumentsMaster",
        Para: JSON.stringify({
          ActionMode: "Select",
  ...
  const fetchVisibleColumns = async () => {
    ...
    const payload = {
      ...
      Para: JSON.stringify({
        EmployeeId: employeeId,
        USPName: "USP_EmployeeDocumentsMaster",
        ActionMode: "List",
        Mode: "Get",
      }),
    };
    ...
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 flex-wrap justify-end">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                >
                  <ColumnSelector
                    procName="USP_EmployeeDocumentsMaster"
      ...
      {!showTable && (
        <LandingIllustration
          ...
          addLabel="Add Employee Document"
          formName={formName}
          description={
            <>
              Search Employee Documents using filters above.
              <br />
