...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const exportCSV = async () => {
    ...
    a.href = url;
    a.download = "Employee_documents.csv";
    a.click();
  };
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Employee Documents");
    XLSX.writeFile(workbook, "Employee_documents.xlsx");
  };
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_EmployeeDocumentsMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
  ...
  const fetchTableData = async () => {
    try {
      ...
      const payload = {
        procName: "EmployeeDocumentsMaster", // ✅ FIX
        Para: JSON.stringify({
          ActionMode: "List",
          CompanyId: 1,
          EntryBy: 1,
 ...
 const fetchDocumentPermissions = async () => {
  ...
  //     SmartyActionStoreInstance.set("EmployeeDocuments", actions);
  //     console.log("🧠 Employee Document Actions:", actions);
  //   }, 300);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Employee Documents</h5>
          </div>
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                ...
                <br />
                OR <br />
                Click Below to add New Employee Document
              </p>
