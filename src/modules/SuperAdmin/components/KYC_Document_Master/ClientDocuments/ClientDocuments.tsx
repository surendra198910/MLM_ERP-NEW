...
const Template: React.FC = () => {
  ...
  const fetchGridColumns = async () => {
    ...
    try {
      const payload = {
        ...
        Para: JSON.stringify({
          UserId: employeeId,
          GridName: "USP_ClientDocumentsMaster",
        }),
      };
  ...
  const fetchExportData = async () => {
    const saved = localStorage.getItem("EmployeeDetails");
    const companyId = saved ? JSON.parse(saved).CompanyId : 1;

    const payload = {
      procName: "ClientDocumentsMaster",
      Para: JSON.stringify({
        ActionMode: "GetReport", // ✅ VERY IMPORTANT
        CompanyId: companyId, // ✅ MISSING KEY FIX
        SearchBy: filterColumn,
        Criteria: searchInput,
        Page: 1,
        PageSize: 0, // ✅ EXPORT MODE
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          EntryBy: employeeId,
          CompanyId: 1, // Add if managed by context
        }),
      };
  ...
  const fetchGridData = async (options?: any) => {
    ...
    try {
      ...
      const saved = localStorage.getItem("EmployeeDetails");
      const companyId = saved ? JSON.parse(saved).CompanyId : 1; // Adjust based on your Auth storage
  ...
  const fetchVisibleColumns = async () => {
    ...
    const payload = {
      ...
      Para: JSON.stringify({
        EmployeeId: employeeId,
        USPName: "USP_ClientDocumentsMaster",
        ActionMode: "List",
        Mode: "Get",
      }),
    };
    ...
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 flex-wrap justify-end">
            ...
            <div className="relative w-full sm:w-[180px]">
              ...
              >
                ...
                >
                  ...
                  {/* <option value="IsAttachment">Is Attachment</option> */}
                </select>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                >
                  <ColumnSelector
                    procName="USP_ClientDocumentsMaster"
      ...
      {!showTable && (
        <LandingIllustration
          ...
          description={
            <>
              Search Client Documents using filters above.
              <br />
...
p-[20px] md:p-[25px] rounded-t-md"
                >
                  <div className="trezo-card-title">
                    <h5 className="!mb-0">
                      {isEdit ? "Edit Client Document" : "Add Client Document"}
                    </h5>
                  </div>
                  <button
                    type="button"
                    ...
                    onSubmit={async (values, { resetForm }) => {
                      ...
                      try {
                        ...
                        const employeeId = saved
                          ...
                          : 0;
                        const companyId = saved
                          ? JSON.parse(saved).CompanyId
                          : 1;
