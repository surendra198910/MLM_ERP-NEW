...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Company Documents");
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_CompanyDocumentsMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
  ...
  const fetchTableData = async () => {
    try {
      ...
      const payload = {
        procName: "CompanyDocumentsMaster", // ✅ FIX
        Para: JSON.stringify({
          ActionMode: "List",
          CompanyId: 1,
          EntryBy: 1,
 ...
 const fetchDocumentPermissions = async () => {
  ...
  //     console.log("🧠 Company Document Actions:", actions);
  //   }, 300);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Company Documents</h5>
          </div>
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                ...
                <br />
                OR <br />
                Click Below to add New Company Document
              </p>
      ...
      outline-0 cursor-pointer transition-all focus:border-primary-button-bg"
                            ...
                            <div>
                              ...
                              <Field
                                type="text"
                                name="DocumentName"
                                placeholder="Enter Company Document Name"
                                className="h-[55px] rounded-md text-black dark:text-white border border-gray-200
