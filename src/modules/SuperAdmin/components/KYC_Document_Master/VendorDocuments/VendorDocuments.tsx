...
const Template: React.FC = () => {
  ...
  const fetchGridColumns = async () => {
    ...
    try {
      const payload = {
        ...
        Para: JSON.stringify({
          UserId: employeeId,
          GridName: "USP_VendorDocumentsMaster",
        }),
      };
  ...
  const handleEdit = async (row) => {
    ...
    // Fetch specific record details to populate the form correctly
    try {
      const saved = localStorage.getItem("EmployeeDetails");
  ...
  const fetchVisibleColumns = async () => {
    ...
    const payload = {
      ...
      Para: JSON.stringify({
        EmployeeId: employeeId,
        USPName: "USP_VendorDocumentsMaster",
        ActionMode: "List",
        Mode: "Get",
      }),
    };
  ...
  return (
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
      ...
      {!showTable && (
        <LandingIllustration
          title="Manage Vendor Documents"
          addLabel="Add Vendor Document"
          formName={formName}
          description={
            <>
              Search Vendor Documents using filters above.
              <br />
...
p-[20px] md:p-[25px] rounded-t-md"
                >
                  <div className="trezo-card-title">
                    <h5 className="!mb-0">
                      {isEdit ? "Edit Vendor Document" : "Add Vendor Document"}
                    </h5>
                  </div>
                  <button
                    type="button"
