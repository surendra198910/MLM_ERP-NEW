...
const applySearch = () => {
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Login Type");
    XLSX.writeFile(workbook, "login_type.xlsx");
  };
  ...
  const [sortColumn, setSortColumn] = useState("LoginTypeId");
...
const DATE_COLUMNS = [
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_LoginTypeMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) =>
              c.IsVisible == 1 &&
              c.ColumnName !== "LoginTypeId" // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder)
      );
 ...
 const fetchEditData = async (id: number) => {
  ...
  const formSchema = Yup.object().shape({
    LoginType: Yup.string().required("Document name is required"),
  });
 ...
 const fetchDocumentPermissions = async () => {
  try {
    ...
    const payload = {
      ...
      Para: JSON.stringify({
        ActionMode: "Forms",
        FormCategoryId: 28, // 👈 category for this page
        EmployeeId: employeeId,
      }),
    };
...
const handlePrint = async () => {
      ...
      <tr>
        ${visibleColumns
          .map((col) => {
           ...
           if (col.ColumnName.toLowerCase().includes("date") && value) {
  ...
  //     console.log("🧠 Login Type Actions:", actions);
  //   }, 300);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
       <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Login Type</h5>
          </div>
              ...
              SmartActions.canAdvancedSearch(CURRENT_FORM_ID)
                ...
                : "bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed"
                    ...
                    >
                      ...
                      <option value="LoginType">Login Type Name</option>
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                Search Login Type data by <br />
                using above filters to edit, delete etc.
                <br />
                OR <br />
                Click Below to add New Login Type
              </p>
                              ...
                              >
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    fetchEditData(task.LoginTypeId);
                                  }}
                                  className={
...
p-[20px] md:p-[25px] rounded-t-md"
                  >
                    <div className="trezo-card-title">
                      <h5 className="!mb-0">
                        {isEdit ? "Edit Login Type" : "Add New Login Type"}
                      </h5>
                    </div>
                    <button
                      type="button"
    ...
    onSubmit={async (values, { resetForm }) => {
      try {
        ...
        if (res?.StatusCode === "1") {
          ShowSuccessAlert(
            isEdit
              ? "Login Type Updated Successfully"
              : "Login Type Added Successfully"
          );
