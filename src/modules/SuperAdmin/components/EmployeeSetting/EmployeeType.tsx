...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const exportExcel = async () => {
    ...
    XLSX.writeFile(workbook, "employee_type.xlsx");
  };
  ...
  const [sortColumn, setSortColumn] = useState("EmployeeTypeId");
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_EmployeeTypeMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) => c.IsVisible == 1 && c.ColumnName !== "EmployeeTypeId", // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder),
      );
    } catch (err) {
  ...
  const fetchTableData = async () => {
    try {
      ...
      const payload = {
        procName: "EmployeeTypeMaster", // ✅ FIX
        Para: JSON.stringify({
          ActionMode: "List",
          CompanyId: 1,
          EntryBy: 1,
  ...
  const formSchema = Yup.object().shape({
    EmployeeType: Yup.string().required("Document name is required"),
  });
 ...
 const fetchDocumentPermissions = async () => {
  ...
  //     console.log("🧠 Employee Type Actions:", actions);
  //   }, 300);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Employee Type</h5>
          </div>
              ...
              SmartActions.canAdvancedSearch(CURRENT_FORM_ID)
                ...
                : "bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed"
                    ...
                    >
                      ...
                      <option value="EmployeeType">Employee Type Name</option>
                    </select>
        ...
        ${SmartActions.canSearch(CURRENT_FORM_ID)
                ...
                <div className="relative group">
                  ...
                  >
                    ...
                    >
                      <ColumnSelector
                        procName="USP_EmployeeTypeMaster"
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                Search Employee Type data by <br />
                using above filters to edit, delete etc.
                <br />
                OR <br />
                Click Below to add New Employee Type
              </p>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (!SmartActions.canEdit(CURRENT_FORM_ID))
                                      return;
                                    fetchEditData(task.EmployeeTypeId);
                                  }}
                                  className={
                                    SmartActions.canEdit(CURRENT_FORM_ID)
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (
                                      ...
                                      return;
                                    handleDelete(task.EmployeeTypeId);
                                  }}
                                  className={
                                    SmartActions.canDelete(CURRENT_FORM_ID)
