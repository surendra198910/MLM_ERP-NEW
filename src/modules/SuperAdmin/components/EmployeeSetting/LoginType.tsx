...
const Template: React.FC = () => {
  ...
  return (
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
      ...
      {!showTable && (
        <LandingIllustration
          title="Login Type Master"
          addLabel="Add Login Type"
          formName={formName}
          description={
            <>
              Search login type using filters above.<br />
              Manage records, export reports and analyse performance.<br />
              <span className="font-medium">OR</span><br />
              Click on Add button to create a new login type entry.
            </>
          }
        />
      )}
                  ...
                  <Formik
                    ...
                    onSubmit={async (values, { resetForm }) => {
                      const confirm = await Swal.fire({
                        title: isEdit ? "Update Login Type?" : "Add Login Type?",
                      ...
                      try {
                        ...
                        const payload = {
                          ...
                          Para: JSON.stringify({
                            ...
                            EditId: isEdit ? Number(editData?.LoginTypeId) : 0,
                            CompanyId: 1,
                            EntryBy: 1,
                          }),
                        };
