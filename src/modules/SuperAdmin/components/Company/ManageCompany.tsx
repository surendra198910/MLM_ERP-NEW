...
const CompanyList: React.FC = () => {
  ...
  const [sortColumn, setSortColumn] = useState<string>("CompanyId");
  ...
  const getFilterPayload = (filter: string, value: string) => {
    ...
    if (filter && value) {
      if (filter === "CompanyName") payload.CompanyNameFilter = value;
      if (filter === "CompanyType") payload.CompanyTypeFilter = value;
      if (filter === "CityName") payload.CityNameFilter = value;
      if (["EmailId", "ContactNo"].includes(filter)) {
        payload.SearchTerm = value;
      }
    }
    return payload;
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        ...
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Companies</h5>
          </div>
        ...
        {!showTable ? (
          ...
          <div className="trezo-card-content -mx-[20px] md:-mx-[25px]">
            ...
            ) : totalCount === 0 && companies.length === 0 ? (
                            ...
                            <div className="flex items-center gap-[9px]">
                              ...
                              >
                                <button
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `/superadmin/company/add-company/edit/${comp.CompanyId}`,
                                    )
                                  }
