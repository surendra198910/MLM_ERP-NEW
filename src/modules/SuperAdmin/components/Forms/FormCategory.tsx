            ...
            <div className="flex items-center gap-2">
              ...
              <PermissionAwareTooltip allowed={SmartActions.canManageColumns(formName)} allowedText="Manage Columns">
                <div className={`h-[34px] flex items-center ${!SmartActions.canManageColumns(formName) ? "pointer-events-none opacity-50" : ""}`}>
                  <ColumnSelector procName="USP_FormCategory" onApply={fetchVisibleColumns} />
                </div>
              </PermissionAwareTooltip>
            ...
            <DialogPanel transition className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all data-[closed]:translate-y-4 data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in sm:my-8 sm:w-full sm:max-w-[550px] data-[closed]:sm:translate-y-0 data-[closed]:sm:scale-95">
              <div className="trezo-card w-full bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                ...
                <div className="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[20px] md:mb-[25px] flex items-center justify-between -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                  <div className="trezo-card-title">
                    <h5 className="!mb-0">{isEdit ? "Edit Form Category" : "Add Form Category"}</h5>
                  </div>
                  <button type="button" className="text-[23px] transition-all leading-none text-black dark:text-white hover:text-primary-button-bg" onClick={() => setOpen(false)}>
                ...
                {editLoading ? (
                  ...
                  <Formik
                    ...
                    initialValues={{
                      ...
                      parentCategory: editData?.ParentCategoryId ? String(editData.ParentCategoryId) : "",
                      ...
                      try {
                        ...
                        if (res?.StatusCode === 1 || res?.StatusCode === "1") {
                          await Swal.fire({
                            ...
                            text: res?.Msg || "Category saved successfully",
                            timer: 1500,
                    ...
                    {({ errors, touched, setFieldValue, values }) => (
                      <Form className="space-y-5">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <span className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center pointer-events-none text-gray-500">
                              <i className="material-symbols-outlined !text-[20px]">expand_more</i>
                            </span>
                          </div>
                          <ErrorMessage name="module" component="p" className="text-red-500 text-sm mt-1" />
                        </div>
                        ...
                        <div>
                          ...
                          />
                          <ErrorMessage name="formCategoryName" component="p" className="text-red-500 text-sm mt-1" />
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex items-center">
                            <div className="h-[55px] w-[55px] flex items-center justify-center bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-[#172036] rounded-l-md border-r-0">
                              <span className="material-symbols-outlined text-2xl" style={{ color: values.iconColor }}>
                        ...
                        <div>
                          ...
                          <div className="flex items-center">
                            <div
                              className="h-[55px] w-[55px] flex items-center justify-center border border-gray-200 dark:border-[#172036] rounded-l-md border-r-0"
      ...
      <IconsPopUpPage
        ...
        onSelectIcon={(icon: string) => {
          if (formikRef.current) {
             formikRef.current.setFieldValue("iconName", icon);
          }
        }}
      />
      <ColorPickerPopup
        ...
        value={formikRef.current?.values?.iconColor || "#1976d2"} 
        onChange={(color: string) => {
          if (formikRef.current) {
            formikRef.current.setFieldValue("iconColor", color);
          }
        }}
      />
    </div>
