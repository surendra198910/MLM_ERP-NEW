...
type Task = {
  ...
  ModuleTitle: string;
  FormCategoryIcon: string;
  ParentCategoryIcon: string;
  FormCategoryIconColor: string;
  ParentCategoryIconColor: string;
  ModuleId: number;
...
const [hasPageAccess, setHasPageAccess] = useState(true);
 ...
 const fetchFormPermissions = async () => {
  ...
  const printTable = async () => {
    ...
    <html>
      <head>
        <title>Print Form Categories</title>
        <style>
  ...
  const fetchTableData = async () => {
    try {
      ...
      const formatted: Task[] = apiRes.map((item: any) => ({
        ...
        FormCategoryIcon: item.FormCategoryIcon || "",
        ParentCategoryIcon: item.ParentCategoryIcon || "",
        FormCategoryIconColor: item.FormCategoryIconColor || "#1976d2",
        ParentCategoryIconColor: item.ParentCategoryIconColor || "#1976d2",
                ...
                <Formik
                  ...
                  initialValues={{
                    ...
                    parentCategory: editData
                      ? String(editData.ParentCategoryId)
                      : "",
                  ...
                  validationSchema={Yup.object().shape({
                    ...
                    formCategoryName: Yup.string().required(
