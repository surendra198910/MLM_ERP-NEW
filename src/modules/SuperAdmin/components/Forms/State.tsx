                      ...
                      try {
                        ...
                        const payload = {
                          ...
                          Para: JSON.stringify({
                            ...
                            EntryBy: 1,
                            EditId: isEdit ? Number(editData?.StateId) : 0, // ✅ FIXED
                          }),
                        };
                        ...
                        if (res?.Status === 1 || res?.Status === "1") {
                          await Swal.fire({
                            ...
                            text: res?.Msg || "State saved successfully",
                            timer: 1500,
                            showConfirmButton: false,
                          });
