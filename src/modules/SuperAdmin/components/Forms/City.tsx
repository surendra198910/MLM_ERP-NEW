                      ...
                      try {
                        ...
                        const payload = {
                          ...
                          Para: JSON.stringify({
                            ...
                            EntryBy: 1,
                            EditId: isEdit ? Number(editData?.CityId) : 0, // ✅ FIXED (important)
                          }),
                        };
                        ...
                        if (res?.Status === 1 || res?.Status === "1") {
                          await Swal.fire({
                            ...
                            text: res?.Msg || "City saved successfully",
                            timer: 1500,
                            showConfirmButton: false,
                          });
                          ...
                          // ✅ Proper refresh (NEW GRID SYSTEM)
                          setPage(1);
                          setSearchTrigger((p) => p + 1);
                          setRefreshGrid((p) => p + 1);
