...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Expense Item");
    XLSX.writeFile(workbook, "expense_item.xlsx");
  };
  ...
  const [sortColumn, setSortColumn] = useState("ExpenseItemId");
  ...
  const fetchVisibleColumns = async () => {
    try {
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) => c.IsVisible == 1 && c.ColumnName !== "ExpenseItemId", // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder),
      );
    } catch (err) {
  ...
  const formSchema = Yup.object().shape({
    ...
    ExpenseItemDescription: Yup.string().required(
      "Expense Item description is required",
    ),
  });
  ...
  //     console.log("🧠 Expense Item Actions:", actions);
  //   }, 300);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Expense Item</h5>
          </div>
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                Search Expense Item data by <br />
                using above filters to edit, delete etc.
                <br />
                OR <br />
                Click Below to add New Expense Item
              </p>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (!SmartActions.canEdit(CURRENT_FORM_ID))
                                      return;
                                    fetchEditData(task.ExpenseItemId);
                                  }}
                                  className={
                                    SmartActions.canEdit(CURRENT_FORM_ID)
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (
                                      ...
                                      return;
                                    handleDelete(task.ExpenseItemId);
                                  }}
                                  className={
                                    SmartActions.canDelete(CURRENT_FORM_ID)
