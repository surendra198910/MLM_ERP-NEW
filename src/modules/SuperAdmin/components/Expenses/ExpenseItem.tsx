...
const ExpenseItem: React.FC = () => {
    const formSchema = Yup.object().shape({
        ExpenseItemName: Yup.string().required("Expense Item Name is required"),
        ItemDescription: Yup.string().required("Description is required"),
        AccountingCode: Yup.string().required("HSN/SAC Code is required"),
        Rate: Yup.number()
    ...
    const [sortColumnKey, setSortColumnKey] = useState<string>("ExpenseItemId");
    ...
    const fetchGridColumns = async () => {
        ...
        try {
            const payload = {
                ...
                Para: JSON.stringify({
                    UserId: employeeId,
                    GridName: "USP_ExpenseItem", // USP_ is needed here
                }),
            };
            ...
            if (Array.isArray(data)) {
                ...
                const reactCols = visibleSorted
                    .filter((c: any) => c.ColumnKey !== "ExpenseItemId") 
                    .map((c: any) => ({
                        id: c.ColumnOrder,
                        name: c.DisplayName,
                        sortable: true,
                        ...
                        cell: (row: any) => {
                            let value = row[c.ColumnKey];
                            // Format booleans (IsITC, Status)
                            if (typeof value === "boolean" || c.ColumnKey === "IsITC") {
                                return value ? "Yes" : "No";
                            }
                            return value ?? "-";
                        }
    ...
    const handleEdit = async (row) => {
        ...
        try {
            const payload = {
                procName: "ExpenseItem",
                Para: JSON.stringify({
                    ActionMode: "Select",
                    EditId: Number(row.ExpenseItemId),
    ...
    const fetchExportData = async () => {
        const payload = {
            ...
            Para: JSON.stringify({
                ...
                Start: 0,
                Length: 0, // Bypass offsets for export
                SortColumn: sortColumnKey || "ExpenseItemId",
    ...
    const handleDelete = async (row: any) => {
        const result = await Swal.fire({
            title: "Are you sure?",
            text: `Delete "${row.ExpenseItemName}" ?`,
            icon: "warning",
        ...
        try {
            ...
            const payload = {
                ...
                Para: JSON.stringify({
                    ...
                    Start: (pageToUse - 1) * perPageToUse, // Handled correctly for SP
                    Length: perPageToUse, // Handled correctly for SP
                    SortColumn: sortColumnKey || "ExpenseItemId",
                    SortDir: sortDirection,
                    CompanyId: getCompanyId()
                }),
    ...
    const fetchVisibleColumns = async () => {
        ...
        const payload = {
            ...
            Para: JSON.stringify({
                EmployeeId: employeeId,
                USPName: "USP_ExpenseItem", // USP_ is needed here
                ActionMode: "List",
                Mode: "Get",
            }),
        };
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3 flex-wrap justify-end">
                        ...
                        <div className="relative w-full sm:w-[180px]">
                           ...
                           ${SmartActions.canAdvancedSearch(formName)
                                ...
                                >
                                    ...
                                    <option value="ExpenseItemName">Expense Item Name</option>
                                    <option value="AccountingCode">Accounting Code</option>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                >
                                    <ColumnSelector
                                        procName="USP_ExpenseItem" // USP_ is needed here
                        ...
                        >
                            <div className="trezo-card w-full bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                                ...
                                >
                                    <div className="trezo-card-title">
                                        <h5 className="!mb-0">
                                            {isEdit ? "Edit Expense Item" : "Add New Expense Item"}
                                        </h5>
                                    </div>
                                    <button
                                        type="button"
                                ...
                                {editLoading ? (
                                    ...
                                    <Formik
                                        initialValues={{
                                            ExpenseItemName: editData?.ExpenseItemName || "",
                                            ItemDescription: editData?.ItemDescription || "",
                                            AccountingCode: editData?.AccountingCode || "",
                                            Rate: editData?.Rate || "",
                                            TaxPercentage: editData?.TaxPercentage || "",
                                            IsITC: editData?.IsITC ?? false,
                                        }}
                                        enableReinitialize
                                            ...
                                            try {
                                                ...
                                                const payload = {
                                                    ...
                                                    Para: JSON.stringify({
                                                        ...
                                                        IsITC: values.IsITC ? 1 : 0,
                                                        Stock: 0, // Backend expects Stock, default 0 as per UI
                                                        Status: 1, // Active Status
                                                        ActionMode: isEdit ? "Update" : "Insert", 
                                                        EditId: isEdit && editData ? Number(editData.ExpenseItemId) : 0,
                                                        CompanyId: getCompanyId(),
                                                        EntryBy: 1,
                                                    }),
                                                };
                                            ...
                                            <Form className="space-y-5">
                                                ...
                                                <div>
                                                    ...
                                                    <Field
                                                        ...
                                                        placeholder="Enter Expense Item Description"
                                                        className="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-button-bg"
                                                    />
                                                    <ErrorMessage
                                                        name="ItemDescription"
