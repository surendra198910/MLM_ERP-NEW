...
const Template: React.FC = () => {
  ...
  const fetchGridColumns = async () => {
    ...
    try {
      const payload = {
        ...
        Para: JSON.stringify({
          UserId: employeeId,
          GridName: "USP_DesignationMaster",
        }),
      };
  ...
  const handleDelete = async (row: any) => {
    const result = await Swal.fire({
      title: "Are you sure?",
      text: `Delete "${row.DesignationName}" ?`,
      icon: "warning",
    ...
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
      ...
      {!showTable && (
        <LandingIllustration
          ...
          description={
            <>
              Search Designation  using filters above.<br />
              Manage records, export reports and analyse performance.<br />
              <span className="font-medium">OR</span><br />
              Click on Add button to create a new designation entry.
            </>
          }
        />
      )}
                      ...
                      try {
                        ...
                        const payload = {
                          ...
                          Para: JSON.stringify({
                            ...
                            EditId: isEdit ? Number(editData?.DesignationId) : 0,
                            CompanyId: 1,
                            EntryBy: 1,
                          }),
                        };
