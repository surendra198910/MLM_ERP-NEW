...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const [sortColumn, setSortColumn] = useState("DesignationId");
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_DesignationMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) => c.IsVisible == 1 && c.ColumnName !== "DesignationId", // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder),
      );
    } catch (err) {
  ...
  const fetchTableData = async () => {
    try {
      ...
      const payload = {
        procName: "DesignationMaster", // ✅ FIX
        Para: JSON.stringify({
          ActionMode: "List",
          CompanyId: 1,
          EntryBy: 1,
  ...
  const fetchEditData = async (id: number) => {
    ...
    try {
      ...
      const response = await universalService(payload);
      const apiRes = response?.data || response;
      const data = Array.isArray(apiRes) ? apiRes[0] : apiRes;
  ...
  const formSchema = Yup.object().shape({
    DesignationName: Yup.string().required("Document name is required"),
  });
...
const fetchDocumentPermissions = async () => {
  try {
    ...
    const payload = {
      ...
      Para: JSON.stringify({
        ActionMode: "Forms",
        FormCategoryId: 7, // 👈 category for this page
        EmployeeId: employeeId,
      }),
    };
  ...
  //     console.log("🧠 Designation Actions:", actions);
  //   }, 300);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Designations</h5>
          </div>
            ...
            : "border-gray-300 text-gray-300 cursor-not-allowed"
                ...
                <div className="relative group">
                  ...
                  >
                    ...
                    >
                      <ColumnSelector
                        procName="USP_DesignationMaster"
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                ...
                <br />
                OR <br />
                Click Below to add New Designation
              </p>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (!SmartActions.canEdit(CURRENT_FORM_ID))
                                      return;
                                    fetchEditData(task.DesignationId);
                                  }}
                                  className={
                                    SmartActions.canEdit(CURRENT_FORM_ID)
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (
                                      ...
                                      return;
                                    handleDelete(task.DesignationId);
                                  }}
                                  className={
                                    SmartActions.canDelete(CURRENT_FORM_ID)
                  ...
                  {editLoading ? (
                    ...
                    <Formik
                      initialValues={{
                        ...
                        IsActive: editData?.IsActive ?? true, // ✅ map correctly
                      }}
                      enableReinitialize
                        ...
                        try {
                          ...
                          const payload = {
                            ...
                            Para: JSON.stringify({
                              ...
                              Status: values.IsActive, // ✅ CORRECT
                              ActionMode: isEdit ? "Update" : "Insert", // ✅ CASE-SENSITIVE
                              DesignationId:
