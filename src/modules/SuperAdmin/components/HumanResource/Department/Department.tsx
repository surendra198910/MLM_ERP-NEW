...
const Template: React.FC = () => {
  ...
  const handleDelete = async (row: any) => {
    const result = await Swal.fire({
      title: "Are you sure?",
      text: `Delete "${row.DepartmentName}" ?`,
      icon: "warning",
                      ...
                      try {
                        ...
                        const payload = {
                          ...
                          Para: JSON.stringify({
                            ...
                            Status: values.IsActive ? 1 : 0, // ✅ FIXED
                            ActionMode: isEdit ? "Update" : "Insert",
                            EditId: isEdit ? Number(editData?.DepartmentId) : 0, // ✅ FIXED
                            CompanyId: 1,
                            EntryBy: 1,
                          }),
                        };
