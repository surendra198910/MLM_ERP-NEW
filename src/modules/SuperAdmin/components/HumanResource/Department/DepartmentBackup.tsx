...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const [sortColumn, setSortColumn] = useState("DepartmentId");
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_DepartmentMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) => c.IsVisible == 1 && c.ColumnName !== "DepartmentId", // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder),
      );
    } catch (err) {
  ...
  const formSchema = Yup.object().shape({
    DepartmentName: Yup.string().required("Document name is required"),
  });
 ...
 const fetchDocumentPermissions = async () => {
  try {
    ...
    // ✅ Permission granted → load SmartActions
  ...
  //     console.log("🧠 Department Actions:", actions);
  //   }, 300);
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                ...
                <br />
                OR <br />
                Click Below to add New Department
              </p>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (!SmartActions.canEdit(CURRENT_FORM_ID))
                                      return;
                                    fetchEditData(task.DepartmentId);
                                  }}
                                  className={
                                    SmartActions.canEdit(CURRENT_FORM_ID)
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (
                                      ...
                                      return;
                                    handleDelete(task.DepartmentId);
                                  }}
                                  className={
                                    SmartActions.canDelete(CURRENT_FORM_ID)
