                ...
                >
                    ...
                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 px-4 py-4">
                        <div className="text-lg font-bold text-gray-800 dark:text-white">
                            {isEditMode
                                ? "Edit Website Banner Image"
                                : "Manage Website Banner Image"}
                        </div>
        ...
        <FaTimes size={14} />
                        ...
                        {Array.isArray(allImages) && allImages.length > 0 && (
                            <div className="mt-4">
                                ...
                                <h5 className="text-md mb-4 text-gray-500 dark:text-gray-300 flex items-center gap-2">
                                    <ImageIcon size={16} />
...
`}
                                            ...
                                            <div className="absolute bottom-0 left-0 right-0 flex items-center justify-between px-2 py-1.5 bg-black/50 backdrop-blur-sm">
                                                ...
                                                <span className="text-[11px] text-white font-medium">
                                                    {img.Status === "Active" ? "Active Banner" : "Inactive"}
                                                </span>
