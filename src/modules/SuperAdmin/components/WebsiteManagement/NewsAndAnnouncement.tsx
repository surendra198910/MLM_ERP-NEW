...
const Template: React.FC = () => {
  ...
  const procedureName = "MangaeNewsAndAnnouncements";
  ...
  const handleDelete = async (row: any) => {
    ...
    try {
      const payload = {
        ...
        Para: JSON.stringify({
          ActionMode: "Delete",
          EditId: row.NewsAndAnnouncementId,
          // CompanyId: 1,
          // ModifiedBy: 1,
        }),
      };
  ...
  return (
    <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
      ...
      {!showTable && (
        <LandingIllustration
          title="Manage News/Announcement"
          addLabel="Add News/Announcement"
          formName={formName}
          description={
            <>
              Search News/Announcement using filters above.
              <br />
              Manage News/Announcement, export reports and analyse performance.
              <br />
              <span className="font-medium">OR</span>
              <br />
              Click on Add button to create a new News/Announcement.
            </>
          }
        />
      )}
      {showTable && (
        ...
        transition-all appearance-none"
              ...
              <PermissionAwareTooltip allowed={canExport}>
                ...
                >
                  <ExportButtons
                    title="News/Announcement Report"
                      ...
                      try {
                        ...
                        const payload = {
                          ...
                          Para: JSON.stringify({
                            ...
                            EditId: editData?.NewsAndAnnouncementId || "",
                            EntryBy: 1,
                          }),
                        };
                        ...
                        if (res?.StatusCode === 1 || res?.StatusCode === "1") {
                          await Swal.fire({
                            ...
                            text:
                              res?.Msg ||
                              "News/Announcement saved successfully",
                            timer: 1500,
                            showConfirmButton: false,
                          });
