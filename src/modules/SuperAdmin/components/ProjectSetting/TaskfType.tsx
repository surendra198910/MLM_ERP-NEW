                ...
                <Formik
                  ...
                  onSubmit={async (values, { resetForm }) => {
                    const confirm = await Swal.fire({
                      title: isEdit ? "Update Task Type?" : "Add Task Type?",
                    ...
                    try {
                      ...
                      const payload = {
                        ...
                        Para: JSON.stringify({
                          ...
                          EditId: isEdit ? Number(editData?.TaskTypeId) : 0, // ✅ FIXED
                          CompanyId: 1,
                          EntryBy: 1,
                        }),
                      };
