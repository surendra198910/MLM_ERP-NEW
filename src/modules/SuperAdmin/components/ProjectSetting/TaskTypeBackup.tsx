...
const [hasPageAccess, setHasPageAccess] = useState(true);
  ...
  const exportCSV = async () => {
    ...
    a.href = url;
    a.download = "client_TaskType.csv";
    a.click();
  };
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Client TaskType");
    XLSX.writeFile(workbook, "client_TaskType.xlsx");
  };
  ...
  const [sortColumn, setSortColumn] = useState("TaskTypeId");
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_TaskTypeMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) => c.IsVisible == 1 && c.ColumnName !== "TaskTypeId", // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder),
      );
    } catch (err) {
 ...
 const fetchDocumentPermissions = async () => {
  try {
    ...
    const payload = {
      ...
      Para: JSON.stringify({
        ActionMode: "Forms",
        FormCategoryId: 31, // 👈 category for this page
        EmployeeId: employeeId,
      }),
    };
  ...
  //     SmartyActionStoreInstance.set("ClientTaskType", actions);
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Task Type</h5>
          </div>
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                Search Task Type data by <br />
                using above filters to edit, delete etc.
                <br />
                OR <br />
                Click Below to add Task Type
              </p>
...
p-[20px] md:p-[25px] rounded-t-md"
                  >
                    <div className="trezo-card-title">
                      <h5 className="!mb-0">
                        {isEdit ? "Edit Task Type" : "Add New Task Type"}
                      </h5>
                    </div>
                    <button
                      type="button"
