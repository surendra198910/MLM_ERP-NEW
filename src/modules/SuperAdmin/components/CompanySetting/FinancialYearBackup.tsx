...
const getCellValue = (row: any, columnName: string) => {
  ...
  const exportExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Financial Year");
    XLSX.writeFile(workbook, "financial_year.xlsx");
  };
  ...
  const [sortColumn, setSortColumn] = useState("FinancialYearId");
...
const DATE_COLUMNS = [
    ...
    try {
      ...
      const payload = {
        ...
        Para: JSON.stringify({
          ...
          USPName: "USP_FinancialYearMaster", // ✅ FIXED
          ActionMode: "List",
          Mode: "Get",
        }),
      };
      ...
      setVisibleColumns(
        cols
          .filter(
            (c) =>
              c.IsVisible == 1 &&
              c.ColumnName !== "FinancialYearId" // 🚫 HIDE DOCUMENT ID
          )
          .sort((a, b) => a.DisplayOrder - b.DisplayOrder)
      );
  ...
  const fetchTableData = async () => {
    try {
      ...
      const payload = {
        procName: "FinancialYearMaster", // ✅ FIX
        Para: JSON.stringify({
          ActionMode: "List",
          CompanyId: 1,
          EntryBy: 1,
  ...
  const fetchEditData = async (id: number) => {
    ...
    try {
      ...
      if (!data || !data.FinancialYearId) {
        throw new Error("Edit data not found");
      }

      setEditData({
        id: data.FinancialYearId,
        DocumentName: data.DocumentName,
        FromDate: data.FromDate?.split("T")[0] || "", // ✅ FIX
        ToDate: data.ToDate?.split("T")[0] || "",     // ✅ FIX
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[10px] md:mb-[10px] sm:flex items-center justify-between pb-5 border-b border-gray-200 -mx-[20px] md:-mx-[25px] px-[20px] md:px-[25px]">
          <div className="trezo-card-title">
            <h5 className="!mb-0">Manage Financial Year</h5>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 sm:w-auto w-full">
            ...
            ${SmartActions.canAdvancedSearch(CURRENT_FORM_ID)
                    ...
                    >
                      ...
                      <option value="DocumentName">Financial Year Name</option>
        ...
        ${SmartActions.canSearch(CURRENT_FORM_ID)
                ...
                <div className="relative group">
                  ...
                  >
                    ...
                    >
                      <ColumnSelector
                        procName="USP_FinancialYearMaster"
          ...
          >
            ...
            <div className="md:max-w-md md:px-3 px-0 py-14">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 text-[15px]">
                ...
                <br />
                OR <br />
                Click Below to add New Financial Year
              </p>
                              ...
                              >
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    fetchEditData(task.FinancialYearId);
                                  }}
                                  className={
                              ...
                              >
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    handleDelete(task.FinancialYearId);
                                  }}
                                  className={
...
p-[20px] md:p-[25px] rounded-t-md"
                  >
                    <div className="trezo-card-title">
                      <h5 className="!mb-0">
                        {isEdit ? "Edit Financial Year" : "Add New Financial Year"}
                      </h5>
                    </div>
                    <button
                      type="button"
                  ...
                  {editLoading ? (
                    ...
                    <Formik
                      initialValues={{
                        ...
                        FromDate: editData?.FromDate || todayDate, // ✅ default today
                        ToDate: editData?.ToDate || todayDate,     // ✅ default today
                        ...
                        try {
                          ...
                          const payload = {
                            ...
                            Para: JSON.stringify({
                              ...
                              FromDate: values.FromDate,   // ✅ SEND
                              ToDate: values.ToDate,       // ✅ SEND
                              IsCurrent: values.IsCurrent,
                              ActionMode: isEdit ? "Update" : "Insert",
                              EditId: isEdit ? Number(editData.id) : 0,
                              CompanyId: 1,
                              EntryBy: 1,
                            }),
                          };
      ...
      outline-0 transition-all focus:border-primary-button-bg"
                              ...
                              <ErrorMessage name="FromDate" component="p" className="text-red-500 text-sm" />
                            </div>
                            ...
                            <div>
                              ...
                              <Field
                                type="date"
                                name="ToDate"   // ✅ FIXED (WAS WRONG)
                                className="h-[55px] rounded-md text-black dark:text-white border border-gray-200
      dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full
      outline-0 transition-all focus:border-primary-button-bg"
                              />

                              <ErrorMessage name="ToDate" component="p" className="text-red-500 text-sm" />
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-[25px] mb-6">
                              ...
                              <div className="flex items-center justify-between pr-4">
                                <label className="font-medium">Is Current:</label>
